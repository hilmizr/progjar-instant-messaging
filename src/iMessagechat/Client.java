...
public class Client  {
	...
	public boolean start() {
		...
		// Send our username to the server as string 
	...
	/*
	 * In console mode, if an error occurs the program will stops
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			// message onlineuser
				...
				client.sendMessage(new iMessage(iMessage.MESSAGE, msg));
			}
		}
		// done disconnect
		client.disconnect();	
